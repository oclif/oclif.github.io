...
_参见代码: [src/commands/generate.ts](https://github.com/oclif/oclif/blob/4.10.1/src/commands/generate.ts)_
...
_参见代码: [src/commands/generate/command.ts](https://github.com/oclif/oclif/blob/4.10.1/src/commands/generate/command.ts)_
...
_参见代码: [src/commands/generate/hook.ts](https://github.com/oclif/oclif/blob/4.10.1/src/commands/generate/hook.ts)_
